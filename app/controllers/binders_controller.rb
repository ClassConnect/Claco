class BindersController < ApplicationController
	...
	def show
		...
		if @access == 0
			error = true
			render "shared/403", :status => 403 and return
		end
	...
	def download
		...
		render "shared/403", :status => 403 and return if @access == 0
	...
	def trash
		...
		#render "shared/403", :status => 403 and return if params[:username] != current_teacher.username
